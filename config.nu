...
source "~/Library/Application Support/nushell/keybindings.nu" # keybindings
source "~/Library/Application Support/nushell/hooks.nu" # hooks
source "~/Library/Application Support/nushell/menus.nu" # menus
...
source "~/Library/Application Support/nushell/completions.nu" # completions
